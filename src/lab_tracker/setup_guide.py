...
_SKILL_DESCRIPTION = (
    ...
    "connect a repo, switch the Lab Tracker server URL, configure watch folders, "
    "enroll commit hooks, bind a project, or when `lt setup status` / a session hook reports "
