...
class SQLAlchemyExperimentRepository(
    SQLAlchemyModelRepository[Experiment, ExperimentModel]
):
    ...
    def query(
        ...
        *,
        ...
        if session_id is not None:
            stmt = stmt.join(
                ExperimentSessionModel,
                ExperimentSessionModel.experiment_id
                == ExperimentModel.experiment_id,
            ).where(
                ExperimentSessionModel.session_id == str(session_id)
            )
        ...
        if dataset_id is not None:
            stmt = stmt.join(
                ExperimentDatasetModel,
                ExperimentDatasetModel.experiment_id
                == ExperimentModel.experiment_id,
            ).where(
        ...
        if project_id is not None:
            stmt = stmt.where(
                ExperimentModel.project_id == str(project_id)
            )
    ...
    def query_sessions(
        ...
        *,
        ...
        stmt = (
            ...
            .join(
                ExperimentSessionModel,
                ExperimentSessionModel.session_id
                == SessionModel.session_id,
            )
            .where(
                ExperimentSessionModel.experiment_id == str(experiment_id)
            )
    ...
    def query_datasets(
        ...
        *,
        ...
        stmt = (
            ...
            .join(
                ExperimentDatasetModel,
                ExperimentDatasetModel.dataset_id
                == DatasetModel.dataset_id,
            )
            .where(
                ExperimentDatasetModel.experiment_id == str(experiment_id)
            )
        ...
        return SQLAlchemyDatasetRepository(self._session).datasets_from_rows(
            rows
        ), total
